      ...
      <div className='max-w-xl sm:mx-auto lg:max-w-2xl'>
        <div className='flex flex-col mb-16 sm:text-center sm:mb-0'>
          <div className='max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12'>
            <h1
              className='mb-7 bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 bg-clip-text text-3xl font-extrabold text-transparent sm:text-5xl'
              data-aos='fade-up'
            ...
            <p
              className='text-base text-gray-500 dark:text-gray-300 fmd:text-lg'
              data-aos='fade-up'
              data-aos-duration='600'
              data-os-delay='300'
            >
